...
class HoversPage(BasePage):
    ...
    # IMG_USER_LOC =  "//div[@class='figure'][{}]"
    # USERNAME_LOC = f"{IMG_USER_LOC}//h5"
    # PROFILE_LINK_LOC = f"{IMG_USER_LOC}//a"
    ...
    def __init__(self,browser):
        ...
        # self.image =WebElement (self.browser.driver, self.IMG_USER_LOC, description= 'Main Page -> Hover over IMG')
        # self.link = WebElement(self.browser.driver, self.PROFILE_LINK_LOC, description='Main Page -> follow link')
        # self.text = WebElement(self.browser.driver, self.USERNAME_LOC, description='Main Page -> UserName')
        self.unique_element = WebElement(self.browser.driver, self.UNIQUE_ELEMENT_LOC, description='Hover header')
