...
class HadlersPage(BasePage):
    ...
    CLICK_URL = (By.XPATH, "//a[contains(text(), 'Click')]")
    TEXT = (By.XPATH, "//h3")
    ...
    def __init__(self, browser):
        ...
        self.click_link = WebElement(self.browser.driver, self.CLICK_URL, description='Main Page -> Click on link')
        self.text_link = WebElement(self.browser.driver, self.TEXT, description='Main Page -> Get text')
